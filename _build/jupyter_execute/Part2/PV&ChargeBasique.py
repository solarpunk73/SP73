...
# L'impact n'étant jamais nul, la priorité est à la réduction des besoins (et ce de manière global): l'électricité est à haute exergie, il faut en profiter au maximum pour ce que l'on ne peut faire autrement. Le solaire thermique devient donc une réponse naturelle à une bonne partie des besoins en chaleur.
